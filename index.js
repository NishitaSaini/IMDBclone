...
function addSearchElements() {
  ...
  if (responseJson.Response == "False") {
    searchContainer.innerHTML = `<div class="noResults text-center"><img src="images/no_image_available.jpg"></div>;<h1 class="text-center text-white">Sorry, We couldn't find any results</h1>`;
  ...
  searchList.forEach((element) => {
    ...
    if (poster == "N/A" || poster == "n/a") {
      poster = "images/no_image_available.jpg";
    }
    ...
    searchContainer.innerHTML += ` <div class="card-container col-lg-3 col-md-4 col-sm-6 ">
                        ...
                        " onerror="this.onerror=null; this.src='images/no_image_available.jpg'" data-holder-rendered="true"></a>
...
function addMoviePageElements() {
  ...
  if (moviePoster == "N/A" || moviePoster == "n/a") {
    moviePoster = "images/no_image_available.jpg";
  }
...
function displayfavoriteList() {
  ...
  // favMsgContainer.innerHTML = `<span class="searched-text">Total Favorites</span><span style="color:white">&nbsp:&nbsp</span><span class="search-result text-white">${totalFavorites}</span>`;
